{!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.booking.table.before', ['product' => $product]) !!}

<table-booking></table-booking>

{!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.booking.table.after', ['product' => $product]) !!}
