...
use Mrpath\CatalogRule\Repositories\CatalogRuleProductRepository;
use Mrpath\Rule\Helpers\Validator;
...
class CatalogRuleProduct
{
     ...
     *
     * @var \Mrpath\CatalogRule\Repositories\CatalogRuleProductRepository
     */
     ...
     * Validator object
     *
     * @var \Mrpath\Rule\Helpers\ValidatorValidator
     */
    protected $validator;
     ...
     * @param  \Mrpath\CatalogRule\Repositories\CatalogRuleProductRepository  $catalogRuleProductRepository
     * @param  \Mrpath\Rule\Helpers\Validator  $validator
     * @return void
     */
     ...
     *
     * @param \Mrpath\CatalogRule\Contracts\CatalogRule  $rule
