...
class CatalogRuleRepository extends Repository
{
     ...
     *
     * @var \Mrpath\CaTaxtegory\Repositories\axCategoryRepository
     */
    ...
    {
        return \Mrpath\CatalogRule\Contracts\CatalogRule::class;
    }
     ...
     *
     * @param  array  $data
     * @return \Mrpath\CatalogRule\Contracts\CatalogRule
     */
