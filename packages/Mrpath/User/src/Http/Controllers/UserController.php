...
namespace Mrpath\User\Http\Controllers;

use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Hash;
use Illuminate\Support\Str;
use Mrpath\Admin\DataGrids\UserDataGrid;
use Mrpath\User\Http\Requests\UserForm;
use Mrpath\User\Repositories\AdminRepository;
use Mrpath\User\Repositories\RoleRepository;
...
class UserController extends Controller
{
     ...
     *
     * @var \Mrpath\User\Repositories\AdminRepository
     */
     ...
     *
     * @var \Mrpath\User\Repositories\RoleRepository
     */
     ...
     *
     * @param  \Mrpath\User\Repositories\AdminRepository  $adminRepository
     * @param  \Mrpath\User\Repositories\RoleRepository  $roleRepository
     * @return void
     */
     ...
     *
     * @param  \Mrpath\User\Http\Requests\UserForm  $request
