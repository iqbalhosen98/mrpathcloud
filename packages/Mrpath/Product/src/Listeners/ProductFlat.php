...
namespace Mrpath\Product\Listeners;
...
class ProductFlat
{
     ...
     * Attribute Object
     *
     * @var \Mrpath\Attribute\Contracts\Attribute
     */
    protected $attribute;
     ...
     *
     * @param  \Mrpath\Product\Contracts\Product  $product
     * @param  \Mrpath\Product\Contracts\Product  $parentProduct
     * @return void
     */
    public function createFlat($product, $parentProduct = null)
    {
        ...
        if (isset($product['channels'])) {
            foreach ($product['channels'] as $channel) {
                $channel = app('Mrpath\Core\Repositories\ChannelRepository')->findOrFail($channel);
