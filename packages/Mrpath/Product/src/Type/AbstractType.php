...
use Mrpath\Inventory\Repositories\InventorySourceRepository;
use Mrpath\Product\Datatypes\CartItemValidationResult;
use Mrpath\Product\Facades\ProductImage;
use Mrpath\Product\Models\ProductAttributeValue;
use Mrpath\Product\Repositories\ProductAttributeValueRepository;
use Mrpath\Product\Repositories\ProductCustomerGroupPriceRepository;
...
abstract class AbstractType
{
     ...
     *
     * @var \Mrpath\Product\Repositories\productImageRepository
     */
     ...
     *
     * @var \Mrpath\Product\Repositories\productVideoRepository
     */
     ...
     * Product instance.
     *
     * @var \Mrpath\Product\Models\Product
     */
    protected $product;
     ...
     * @return \Mrpath\Product\Type\AbstractType
     */
     ...
     *
     * @param  \Mrpath\Attribute\Contracts\Group  $group
    ...
    public function haveSpecialPrice($qty = null)
    {
        ...
        $rulePrice = app('Mrpath\CatalogRule\Helpers\CatalogRuleProductPrice')->getRulePrice($this->product);
     ...
     * Get tax category.
     *
     * @return \Mrpath\Tax\Models\TaxCategory
     */
     ...
     *
     * @param  \Mrpath\Checkout\Contracts\CartItem $item
     * @return \Mrpath\Checkout\Contracts\CartItem|\Mrpath\Sales\Contracts\OrderItem|\Mrpath\Sales\Contracts\InvoiceItem|\Mrpath\Sales\Contracts\ShipmentItem|\Mrpath\Customer\Contracts\Wishlist
     */
     ...
     *
     * @param  \Mrpath\Customer\Contracts\CartItem|\Mrpath\Checkout\Contracts\CartItem $item
     * @return array
     */
    ...
    public function getCustomerGroupPricingOffers()
    {
        ...
        if (auth()->guard()->check()) {
            ...
            $customerGroupRepository = app('Mrpath\Customer\Repositories\CustomerGroupRepository');
