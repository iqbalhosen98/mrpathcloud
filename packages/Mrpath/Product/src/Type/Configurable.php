...
use Mrpath\Checkout\Models\CartItem as CartItemModel;
...
class Configurable extends AbstractType
{
     ...
     * Get default variant.
     *
     * @return \Mrpath\Product\Models\Product
     */
     ...
     *
     * @param  \Mrpath\Customer\Contracts\Wishlist  $item
     * @return bool
     */
    ...
    public function getOfferPrice()
    {
        ...
        foreach ($this->product->variants as $variant) {
            $rulePrice = app('Mrpath\CatalogRule\Helpers\CatalogRuleProductPrice')->getRulePrice($variant);
    ...
    {
        $childProduct = app('Mrpath\Product\Repositories\ProductRepository')->findOneByField('id', $data['selected_configurable_option']);
     ...
     *
     * @param  \Mrpath\Customer\Contracts\Wishlist|\Mrpath\Checkout\Contracts\CartItem  $item
     * @return array
     */
    public function getBaseImage($item)
    {
        if ($item instanceof \Mrpath\Customer\Contracts\Wishlist) {
            if (isset($item->additional['selected_configurable_option'])) {
            ...
            if ($item instanceof \Mrpath\Checkout\Contracts\CartItem) {
     ...
     *
     * @param  \Mrpath\Product\Type\CartItem  $item
    ...
    {
        $configurableOption = app('Mrpath\Product\Helpers\ConfigurableOption');
