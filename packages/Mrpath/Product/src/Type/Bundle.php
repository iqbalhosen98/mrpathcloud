...
use Mrpath\Product\Helpers\BundleOption;
use Mrpath\Product\Repositories\ProductAttributeValueRepository;
use Mrpath\Product\Repositories\ProductBundleOptionProductRepository;
use Mrpath\Product\Repositories\ProductBundleOptionRepository;
...
class Bundle extends AbstractType
{
     ...
     *
     * @var \Mrpath\Product\Repositories\ProductBundleOptionRepository
     */
     ...
     *
     * @var \Mrpath\Product\Helpers\BundleOption
     */
     ...
     * @param  \Mrpath\Product\Repositories\ProductBundleOptionRepository  $productBundleOptionRepository
     * @param  \Mrpath\Product\Repositories\ProductBundleOptionProductRepository  $productBundleOptionProductRepository
     * @param  \Mrpath\Product\Helpers\BundleOption  $bundleOptionHelper
     ...
     * Get product regular minimal price.
     *
     * @param  \Mrpath\Product\Contracts\ProductBundleOption  $option
     * @param  bool  $minPrice
     * @return float
     */
    ...
    {
        $bundleOption = app('Mrpath\Product\Helpers\BundleOption');
