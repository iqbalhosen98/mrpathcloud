...
class ProductRepository extends Repository
{
    ...
    {
        return \Mrpath\Product\Contracts\Product::class;
    }
     ...
     *
     * @param  string  $slug
     * @return \Mrpath\Product\Contracts\ProductFlat
     */
            ...
            if ($priceFilter = request('price')) {
                ...
                if (count($priceRange) > 0) {
                    ...
                    if (auth()->guard()->check()) {
                        ...
                        $customerGuestGroup = app('Mrpath\Customer\Repositories\CustomerGroupRepository')->getCustomerGuestGroup();
     ...
     *
     * @param  Mrpath\Product\Models\ProductFlat  $query
     ...
     *
     * @param  \Mrpath\Product\Models\Product  $sourceProduct
     * @return void
     */
     ...
     *
     * @param  \Mrpath\Product\Models\Product  $originalProduct
     * @param  \Mrpath\Product\Models\Product  $copiedProduct
     * @return void
     */
