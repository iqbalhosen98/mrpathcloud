...
class ProductFlatRepository extends Repository
{
    ...
    {
        return \Mrpath\Product\Contracts\ProductFlat::class;
    }
     ...
     *
     * @param  \Mrpath\Attribute\Models\Attribute $attribute
     * @param  \Mrpath\Product\Listeners\ProductFlat $listener
     * @return object
     */
    public function updateAttributeColumn(
        \Mrpath\Attribute\Models\Attribute $attribute,
        \Mrpath\Product\Listeners\ProductFlat $listener
    ) {
        return $this->model
