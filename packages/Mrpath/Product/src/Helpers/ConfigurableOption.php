...
namespace Mrpath\Product\Helpers;

use Mrpath\Product\Facades\ProductImage;
use Mrpath\Product\Facades\ProductVideo;
...
class ConfigurableOption extends AbstractProduct
{
     ...
     *
     * @param  \Mrpath\Product\Models\Product|\Mrpath\Product\Contracts\ProductFlat  $product
     * @return array
     */
     ...
     *
     * @param  \Mrpath\Product\Contracts\Product|\Mrpath\Product\Contracts\ProductFlat  $currentProduct
    ...
    public function getOptions($currentProduct, $allowedProducts)
    {
        ...
        foreach ($allowedProducts as $product) {
            if ($product instanceof \Mrpath\Product\Models\ProductFlat) {
            ...
            foreach ($allowAttributes as $productAttribute) {
                ...
                if ($attributeValue == '' && $product instanceof \Mrpath\Product\Models\ProductFlat) {
     ...
     *
     * @param  \Mrpath\Attribute\Contracts\Attribute  $attribute
     * @param  array  $options
     * @return array
     */
    ...
    protected function getVariantPrices($product)
    {
        ...
        foreach ($this->getAllowedProducts($product) as $variant) {
            if ($variant instanceof \Mrpath\Product\Models\ProductFlat) {
