 ...
 *
 * @package Mrpath\Product\Helpers
 */
class GenerateProduct
{
    /**
     ...
     *
     * @var \Mrpath\Product\Repositories\AttributeFamilyRepository
     */
     ...
     *
     * @param  \Mrpath\Product\Repositories\ProductRepository  $productImage
     * @param  \Mrpath\Product\Repositories\AttributeFamilyRepository  $productImage
     * @return void
     */
    ...
    public function generateDemoBrand()
    {
        ...
        if (! AttributeOption::where(['attribute_id' => $brand->id])->exists()) {
            ...
            AttributeOption::create([
                'admin_name'   => 'Mrpath Demo Brand (c) 2020',
