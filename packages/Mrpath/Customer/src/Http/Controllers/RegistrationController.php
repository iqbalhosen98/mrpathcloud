...
namespace Mrpath\Customer\Http\Controllers;

use Cookie;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Mail;
use Illuminate\Support\Str;
use Mrpath\Core\Repositories\SubscribersListRepository;
use Mrpath\Customer\Http\Requests\CustomerRegistrationRequest;
use Mrpath\Customer\Mail\RegistrationEmail;
use Mrpath\Customer\Mail\VerificationEmail;
use Mrpath\Customer\Repositories\CustomerGroupRepository;
use Mrpath\Customer\Repositories\CustomerRepository;
use Mrpath\Shop\Mail\SubscriptionEmail;
...
class RegistrationController extends Controller
{
     ...
     *
     * @var \Mrpath\Core\Repositories\SubscribersListRepository
     */
     ...
     *
     * @param  \Mrpath\Customer\Repositories\CustomerRepository  $customer
     * @param  \Mrpath\Customer\Repositories\CustomerGroupRepository  $customerGroupRepository
     * @param  \Mrpath\Core\Repositories\SubscribersListRepository  $subscriptionRepository
     * @return void
     */
     ...
     *
     * @param  \Mrpath\Customer\Http\Requests\CustomerRegistrationRequest  $request
