...
namespace Mrpath\Customer\Models;
...
use Mrpath\Core\Models\SubscribersListProxy;
use Mrpath\Customer\Contracts\Customer as CustomerContract;
use Mrpath\Customer\Database\Factories\CustomerFactory;
use Mrpath\Customer\Notifications\CustomerResetPassword;
use Mrpath\Product\Models\ProductReviewProxy;
...
class Customer extends Authenticatable implements CustomerContract, JWTSubject
{
     ...
     *
     * @return \Mrpath\Customer\Database\Factories\CustomerFactory
     */
