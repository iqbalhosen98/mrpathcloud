...
use Mrpath\Attribute\Repositories\AttributeOptionRepository;
use Mrpath\Product\Facades\ProductImage;
use Mrpath\Product\Helpers\Review;
use Mrpath\Product\Models\Product as ProductModel;
...
use Mrpath\Velocity\Repositories\OrderBrandsRepository;
...
class Helper extends Review
{
     ...
     *
     * @var \Mrpath\Product\Contracts\Product
     */
     ...
     *
     * @var \Mrpath\Velocity\Repositories\OrderBrandsRepository
     */
     ...
     *
     * @var \Mrpath\Attribute\Repositories\AttributeOptionRepository
     */
     ...
     *
     * @param  \Mrpath\Product\Contracts\Product                        $productModel
     * @param  \Mrpath\Velocity\Repositories\OrderBrandsRepository      $orderBrands
     * @param  \Mrpath\Attribute\Repositories\AttributeOptionRepository $attributeOptionRepository
     * @param  \Mrpath\Product\Repositories\ProductReviewRepository     $productReviewRepository
     * @param  \Mrpath\Velocity\Repositories\VelocityMetadataRepository $velocityMetadataRepository
     * @return void
     */
     ...
     *
     * @return \Mrpath\Velocity\Repositories\VelocityMetadataRepository
     */
    ...
    {
        $reviewHelper = app('Mrpath\Product\Helpers\Review');
