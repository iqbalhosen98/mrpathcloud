    ...
    <div class="content">
        ...
        <form method="POST" action="" @submit.prevent="onSubmit" enctype="multipart/form-data">
            ...
            <div class="page-content">
                ...
                {!! view_render_event('mrpath.admin.content.create_form_accordian.page.before') !!}

                <accordian :title="'{{ __('velocity::app.admin.contents.tab.page') }}'" :active="true">
                    <div slot="body">

                        {!! view_render_event('mrpath.admin.content.create_form_accordian.page.controls.before') !!}
                        ...
                        {!! view_render_event('mrpath.admin.content.create_form_accordian.page.controls.after') !!}

                    </div>
                </accordian>

                {!! view_render_event('mrpath.admin.content.create_form_accordian.page.after') !!}

                {!! view_render_event('mrpath.admin.content.create_form_accordian.content.before') !!}

                <accordian :title="'{{ __('velocity::app.admin.contents.tab.content') }}'" :active="true">
                    <div slot="body">

                        {!! view_render_event('mrpath.admin.content.create_form_accordian.content.controls.before') !!}

                            <content-type></content-type>

                        {!! view_render_event('mrpath.admin.content.create_form_accordian.content.controls.after') !!}

                    </div>
                </accordian>

                {!! view_render_event('mrpath.admin.content.create_form_accordian.content.after') !!}
