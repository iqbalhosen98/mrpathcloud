{!! view_render_event('mrpath.admin.content.edit_form_accordian.content.product.before') !!}

    <catalog-product></catalog-product>

{!! view_render_event('mrpath.admin.content.edit_form_accordian.content.product.after') !!}
@push('scripts')
        ...
        <div>
            ...
            <div v-if="catalog_type == 'custom'">
                <field-autocomplete
                    ...
                    :linkedResults='@json(app('Mrpath\Velocity\Repositories\ContentRepository')->getProducts($content->id))'
                ></field-autocomplete>
            </div>
        </div>
