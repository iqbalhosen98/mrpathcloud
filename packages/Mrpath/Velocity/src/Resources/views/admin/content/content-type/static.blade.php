{!! view_render_event('mrpath.admin.content.create_form_accordian.content.static.before') !!}
...
{!! view_render_event('mrpath.admin.content.create_form_accordian.content.static.after') !!}