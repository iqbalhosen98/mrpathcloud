    ...
    <div class="content">
        ...
        <form
            ...
            <div class="page-content">
                ...
                {!! view_render_event('mrpath.admin.content.edit_form_accordian.page.before', ['content' => $content]) !!}

                <accordian :title="'{{ __('velocity::app.admin.contents.tab.page') }}'" :active="true">
                    <div slot="body">

                        {!! view_render_event('mrpath.admin.content.edit_form_accordian.page.controls.before', ['content' => $content]) !!}
                        ...
                        {!! view_render_event('mrpath.admin.content.edit_form_accordian.page.controls.after', ['content' => $content]) !!}

                    </div>
                </accordian>

                {!! view_render_event('mrpath.admin.content.edit_form_accordian.page.after', ['content' => $content]) !!}

                {!! view_render_event('mrpath.admin.content.edit_form_accordian.content.before', ['content' => $content]) !!}

                <accordian :title="'{{ __('velocity::app.admin.contents.tab.content') }}'" :active="true">
                    <div slot="body">

                        {!! view_render_event('mrpath.admin.content.edit_form_accordian.content.controls.before', ['content' => $content]) !!}

                            <content-type></content-type>

                        {!! view_render_event('mrpath.admin.content.edit_form_accordian.content.controls.after', ['content' => $content]) !!}

                    </div>
                </accordian>

                {!! view_render_event('mrpath.admin.content.edit_form_accordian.content.after', ['content' => $content]) !!}
...
@push('scripts')
    <script src="{{ asset('vendor/mrpath/admin/assets/js/tinyMCE/tinymce.min.js') }}"></script>
    ...
    <script type="text/x-template" id="content-type-template">
        <div>
            ...
            <div v-if="content_type == 'link'">
                {!! view_render_event('mrpath.admin.content.edit_form_accordian.content.link.before', ['content' => $content]) !!}
                ...
                {!! view_render_event('mrpath.admin.content.edit_form_accordian.content.link.after', ['content' => $content]) !!}
            </div>
            ...
            <div v-else-if="content_type == 'static'">
                {!! view_render_event('mrpath.admin.content.edit_form_accordian.content.static.before', ['content' => $content]) !!}
                ...
                {!! view_render_event('mrpath.admin.content.edit_form_accordian.content.static.after', ['content' => $content]) !!}
            </div>
