...
{!! view_render_event('mrpath.admin.content.create_form_accordian.content.link.before') !!}
...
{!! view_render_event('mrpath.admin.content.create_form_accordian.content.link.after') !!}