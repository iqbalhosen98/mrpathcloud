    ...
    <div class="content">
        ...
        <form method="POST" action="" @submit.prevent="onSubmit" enctype="multipart/form-data">
            ...
            <div class="page-content">
                ...
                {!! view_render_event('mrpath.admin.category.edit_form_accordian.general.before', ['velocityCategory' => $velocityCategory]) !!}

                <accordian :title="'{{ __('velocity::app.admin.category.tab.general') }}'" :active="true">
                    <div slot="body">

                        {!! view_render_event('mrpath.admin.category.edit_form_accordian.general.content.before', ['velocityCategory' => $velocityCategory]) !!}
                        ...
                        {!! view_render_event('mrpath.admin.category.edit_form_accordian.general.content.after', ['velocityCategory' => $velocityCategory]) !!}

                    </div>
                </accordian>

                {!! view_render_event('mrpath.admin.category.edit_form_accordian.general.after', ['velocityCategory' => $velocityCategory]) !!}
