@inject ('toolbarHelper', 'Mrpath\Product\Helpers\Toolbar')
@inject ('productRepository', 'Mrpath\Product\Repositories\ProductRepository')
...
@section('seo')
    ...
    @if (core()->getConfigData('catalog.rich_snippets.categories.enable'))
        <script type="application/ld+json">
            {!! app('Mrpath\Product\Helpers\SEO')->getCategoryJsonLd($category) !!}
        </script>
    @endif
@stop
...
@push('scripts')
    <script type="text/x-template" id="category-template">
        <section class="row col-12 velocity-divide-page category-page-wrapper">
            {!! view_render_event('mrpath.shop.productOrCategory.index.before', ['category' => $category]) !!}
                ...
                @if ($isProductsDisplayMode)
                    ...
                    <div
                        ...
                        <template v-else-if="products.length > 0">
                            ...
                            {!! view_render_event('mrpath.shop.productOrCategory.index.pagination.before', ['category' => $category]) !!}

                            <div class="bottom-toolbar" v-html="paginationHTML"></div>

                            {!! view_render_event('mrpath.shop.productOrCategory.index.pagination.after', ['category' => $category]) !!}
                        </template>
            ...
            {!! view_render_event('mrpath.shop.productOrCategory.index.after', ['category' => $category]) !!}
        </section>
    </script>
