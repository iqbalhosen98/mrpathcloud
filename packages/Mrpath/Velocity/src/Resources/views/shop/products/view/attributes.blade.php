@inject ('productViewHelper', 'Mrpath\Product\Helpers\View')

{!! view_render_event('mrpath.shop.products.view.attributes.before', ['product' => $product]) !!}
    @php
...
{!! view_render_event('mrpath.shop.products.view.attributes.after', ['product' => $product]) !!}