...
{!! view_render_event('mrpath.shop.products.list.card.before', ['product' => $product]) !!}
    @if (isset($list) && $list)
            ...
            <div class="product-image">
                <a
                    ...
                    <img
                        ...
                        :onerror="`this.src='${this.$root.baseUrl}/vendor/mrpath/ui/assets/images/product/large-product-placeholder.png'`" alt="" />
        ...
        <div class="card grid-card product-card-new">
            <a
                ...
                <img
                    ...
                    :onerror="`this.src='${this.$root.baseUrl}/vendor/mrpath/ui/assets/images/product/large-product-placeholder.png'`" />
...
{!! view_render_event('mrpath.shop.products.list.card.after', ['product' => $product]) !!}
