@if ($product->type == 'bundle')
    ...
    {!! view_render_event('mrpath.shop.products.view.bundle-options.before', ['product' => $product]) !!}

    <bundle-option-list></bundle-option-list>

    {!! view_render_event('mrpath.shop.products.view.bundle-options.after', ['product' => $product]) !!}
            ...
            Vue.component('bundle-option-list', {
                ...
                data: function() {
                    return {
                        ...
                        config: @json(app('Mrpath\Product\Helpers\BundleOption')->getBundleConfig($product)),
                    }
                },
