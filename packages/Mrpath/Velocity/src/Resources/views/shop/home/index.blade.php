...
@inject ('productRatingHelper', 'Mrpath\Product\Helpers\Review')
...
@section('full-content-wrapper')
    ...
    <div class="full-content-wrapper">
        {!! view_render_event('mrpath.shop.home.content.before') !!}
        ...
        {{ view_render_event('mrpath.shop.home.content.after') }}
    </div>
