        ...
        <accordian :title="'{{ __('shop::app.checkout.payment-methods') }}'" :active="true">
            ...
            <div class="payment-methods" slot="body">
                @foreach ($paymentMethods as $payment)
                    ...
                    {!! view_render_event('mrpath.shop.checkout.payment-method.before', ['payment' => $payment]) !!}
                    ...
                    <div class="row col-12">
                        ...
                        <div class="pl40">
                            ...
                            <?php $additionalDetails = \Mrpath\Payment\Payment::getAdditionalDetails($payment['method']); ?>
                    ...
                    {!! view_render_event('mrpath.shop.checkout.payment-method.after', ['payment' => $payment]) !!}
