...
@section('page-detail-wrapper')
    ...
    {!! view_render_event('mrpath.shop.customers.account.profile.edit.before', ['customer' => $customer]) !!}
    ...
    <form
        ...
        <div class="account-table-content">
            ...
            {!! view_render_event('mrpath.shop.customers.account.profile.edit_form_controls.before', ['customer' => $customer]) !!}
            ...
            {!! view_render_event('mrpath.shop.customers.account.profile.edit.first_name.after', ['customer' => $customer]) !!}
            ...
            {!! view_render_event('mrpath.shop.customers.account.profile.edit.last_name.after', ['customer' => $customer]) !!}
            ...
            {!! view_render_event('mrpath.shop.customers.account.profile.edit.gender.after', ['customer' => $customer]) !!}
            ...
            {!! view_render_event('mrpath.shop.customers.account.profile.edit.date_of_birth.after', ['customer' => $customer]) !!}
            ...
            {!! view_render_event('mrpath.shop.customers.account.profile.edit.email.after', ['customer' => $customer]) !!}
            ...
            {!! view_render_event('mrpath.shop.customers.account.profile.edit.phone.after', ['customer' => $customer]) !!}
            ...
            {!! view_render_event('mrpath.shop.customers.account.profile.edit.image.after', ['customer' => $customer]) !!}
            ...
            {!! view_render_event('mrpath.shop.customers.account.profile.edit.oldpassword.after', ['customer' => $customer]) !!}
            ...
            {!! view_render_event('mrpath.shop.customers.account.profile.edit.password.after', ['customer' => $customer]) !!}
            ...
            {!! view_render_event('mrpath.shop.customers.account.profile.edit_form_controls.after', ['customer' => $customer]) !!}
    ...
    {!! view_render_event('mrpath.shop.customers.account.profile.edit.after', ['customer' => $customer]) !!}
@endsection
