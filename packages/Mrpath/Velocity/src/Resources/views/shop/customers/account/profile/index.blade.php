...
@section('page-detail-wrapper')
    ...
    {!! view_render_event('mrpath.shop.customers.account.profile.view.before', ['customer' => $customer]) !!}

    <div class="account-table-content profile-page-content">
        <div class="table">
            <table>
                <tbody>
                    {!! view_render_event('mrpath.shop.customers.account.profile.view.table.before', ['customer' => $customer]) !!}
                    ...
                    {!! view_render_event('mrpath.shop.customers.account.profile.view.table.first_name.after', ['customer' => $customer]) !!}
                    ...
                    {!! view_render_event('mrpath.shop.customers.account.profile.view.table.last_name.after', ['customer' => $customer]) !!}
                    ...
                    {!! view_render_event('mrpath.shop.customers.account.profile.view.table.gender.after', ['customer' => $customer]) !!}
                    ...
                    {!! view_render_event('mrpath.shop.customers.account.profile.view.table.date_of_birth.after', ['customer' => $customer]) !!}
                    ...
                    {!! view_render_event('mrpath.shop.customers.account.profile.view.table.after', ['customer' => $customer]) !!}
                </tbody>
            </table>
        </div>
    ...
    {!! view_render_event('mrpath.shop.customers.account.profile.view.after', ['customer' => $customer]) !!}
@endsection
