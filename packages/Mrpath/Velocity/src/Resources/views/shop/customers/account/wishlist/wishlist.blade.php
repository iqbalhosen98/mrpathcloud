...
@section('page-detail-wrapper')
    ...
    {!! view_render_event('mrpath.shop.customers.account.wishlist.list.before', ['wishlist' => $items]) !!}
    ...
    {!! view_render_event('mrpath.shop.customers.account.wishlist.list.after', ['wishlist' => $items]) !!}
@endsection
