...
<div class="auth-content">
    {!! view_render_event('mrpath.shop.customers.reset_password.before') !!}
            ...
            <div class="container">
                <div class="col-lg-10 col-md-12 offset-lg-1">
                    ...
                    <div class="body col-12">
                        ...
                        {!! view_render_event('mrpath.shop.customers.forget_password.before') !!}
                        ...
                        <form
                            ...
                            {!! view_render_event('mrpath.shop.customers.forget_password_form_controls.before') !!}
                            ...
                            {!! view_render_event('mrpath.shop.customers.forget_password_form_controls.after') !!}
                        ...
                        {!! view_render_event('mrpath.shop.customers.forget_password.after') !!}
                    </div>
                </div>
            </div>
        </div>
