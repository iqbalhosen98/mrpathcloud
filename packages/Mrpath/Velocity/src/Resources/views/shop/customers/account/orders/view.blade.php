...
@section('page-detail-wrapper')
    ...
    {!! view_render_event('mrpath.shop.customers.account.orders.view.before', ['order' => $order]) !!}
                ...
                <div class="order-box-container">
                    <div class="box">
                        ...
                        <div class="box-content">
                            ...
                            {!! view_render_event('mrpath.shop.customers.account.orders.view.billing-address.after', ['order' => $order]) !!}
                        </div>
                    </div>
                    ...
                    @if ($order->shipping_address)
                        <div class="box">
                            ...
                            <div class="box-content">
                                ...
                                {!! view_render_event('mrpath.shop.customers.account.orders.view.shipping-address.after', ['order' => $order]) !!}
                            </div>
                        </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                ...
                                {!! view_render_event('mrpath.shop.customers.account.orders.view.shipping-method.after', ['order' => $order]) !!}
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="box">
                        ...
                        <div class="box-content">
                            ...
                            @php $additionalDetails = \Mrpath\Payment\Payment::getAdditionalDetails($order->payment->method); @endphp
                            ...
                            {!! view_render_event('mrpath.shop.customers.account.orders.view.payment-method.after', ['order' => $order]) !!}
                        </div>
                    </div>
                </div>
            </div>
    ...
    {!! view_render_event('mrpath.shop.customers.account.orders.view.after', ['order' => $order]) !!}
@endsection
