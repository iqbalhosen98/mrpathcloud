...
namespace Mrpath\Category\Http\Controllers;

use Mrpath\Admin\DataGrids\CategoryDataGrid;
use Mrpath\Attribute\Repositories\AttributeRepository;
use Mrpath\Category\Http\Requests\CategoryRequest;
...
class CategoryController extends Controller
{
     ...
     *
     * @param  \Mrpath\Category\Http\Requests\CategoryRequest  $categoryRequest
     ...
     *
     * @param  \Mrpath\Category\Models\Category $category
     * @return bool
     */
