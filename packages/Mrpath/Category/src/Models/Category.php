...
use Mrpath\Category\Contracts\Category as CategoryContract;
use Mrpath\Category\Database\Factories\CategoryFactory;
...
class Category extends TranslatableModel implements CategoryContract
{
     ...
     *
     * @param  \Mrpath\Velocity\Contracts\Category[]  $categoryTree
     * @return \Mrpath\Velocity\Contracts\Category
     */
