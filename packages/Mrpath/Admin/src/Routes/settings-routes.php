...
use Mrpath\Core\Http\Controllers\ChannelController;
use Mrpath\Core\Http\Controllers\CurrencyController;
use Mrpath\Core\Http\Controllers\ExchangeRateController;
use Mrpath\Core\Http\Controllers\LocaleController;
use Mrpath\Core\Http\Controllers\SliderController;
use Mrpath\Inventory\Http\Controllers\InventorySourceController;
use Mrpath\Tax\Http\Controllers\TaxCategoryController;
use Mrpath\Tax\Http\Controllers\TaxController;
use Mrpath\Tax\Http\Controllers\TaxRateController;
use Mrpath\User\Http\Controllers\RoleController;
use Mrpath\User\Http\Controllers\UserController;
