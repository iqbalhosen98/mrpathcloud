...
class ProductDataGrid extends DataGrid
{
    ...
    {
        $product = app(\Mrpath\Product\Repositories\ProductRepository::class)->find($row->product_id);

        $inventorySources = app(\Mrpath\Inventory\Repositories\InventorySourceRepository::class)->findWhere(['status' => 1]);
