...
use Mail;
use Mrpath\Admin\DataGrids\CustomerDataGrid;
use Mrpath\Admin\DataGrids\CustomerOrderDataGrid;
use Mrpath\Admin\DataGrids\CustomersInvoicesDataGrid;
use Mrpath\Admin\Http\Controllers\Controller;
use Mrpath\Admin\Mail\NewCustomerNotification;
...
class CustomerController extends Controller
{
     ...
     *
     * @param  int  $id
     * @return \Mrpath\Admin\DataGrids\CustomersInvoicesDataGrid
     */
     ...
     *
     * @param  int  $id
     * @return \Mrpath\Admin\DataGrids\CustomerOrderDataGrid
     */
