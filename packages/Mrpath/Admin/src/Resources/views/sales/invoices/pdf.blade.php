...
<html>
    <head>
        ...
        <style type="text/css">
            @font-face {
                font-family: 'Hind';
                src: url({{ asset('vendor/mrpath/ui/assets/fonts/Hind/Hind-Regular.ttf') }}) format('truetype');
            }

            @font-face {
                font-family: 'Noto Sans';
                src: url({{ asset('vendor/mrpath/ui/assets/fonts/Noto/NotoSans-Regular.ttf') }}) format('truetype');
            }
        </style>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    @php $additionalDetails = \Mrpath\Payment\Payment::getAdditionalDetails($invoice->order->payment->method); @endphp
