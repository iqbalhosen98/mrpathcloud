...
@push('scripts')
            ...
            <form method="POST" action="{{ route('admin.catalog-rules.update', $catalogRule->id) }}" @submit.prevent="onSubmit">
                ...
                <div class="page-content">
                    <div class="form-container">
                        ...
                        {!! view_render_event('mrpath.admin.promotions.catalog-rules.create.before') !!}
                        ...
                        {!! view_render_event('mrpath.admin.promotions.catalog-rules.create.after') !!}
                    </div>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        Vue.component('catalog-rule-condition-item', {
            ...
            data: function() {
                return {
                    condition_attributes: @json(app('\Mrpath\CatalogRule\Repositories\CatalogRuleRepository')->getConditionAttributes()),
