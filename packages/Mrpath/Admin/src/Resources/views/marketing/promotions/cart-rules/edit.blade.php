...
@push('scripts')
            ...
            <form method="POST" action="{{ route('admin.cart-rules.update', $cartRule->id) }}" @submit.prevent="onSubmit">
                ...
                <div class="page-content">
                    <div class="form-container">
                        ...
                        {!! view_render_event('mrpath.admin.promotions.cart-rules.create.before') !!}
                        ...
                        {!! view_render_event('mrpath.admin.promotions.cart-rules.create.after') !!}
    ...
    @push('scripts')
        @include('admin::export.export', ['gridName' => app('Mrpath\Admin\DataGrids\CartRuleCouponDataGrid')])
    @endpush
    ...
    <script>
        ...
        Vue.component('cart-rule-condition-item', {
            ...
            data: function() {
                return {
                    condition_attributes: @json(app('\Mrpath\CartRule\Repositories\CartRuleRepository')->getConditionAttributes()),
