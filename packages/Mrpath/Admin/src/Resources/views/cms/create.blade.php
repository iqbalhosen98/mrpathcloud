        ...
        <form method="POST" action="{{ route('admin.cms.store') }}" @submit.prevent="onSubmit">
            ...
            <div class="page-content">
                ...
                <div class="form-container">
                    ...
                    {!! view_render_event('mrpath.admin.cms.pages.create_form_accordian.general.before') !!}
                    ...
                    <accordian :title="'{{ __('admin::app.cms.pages.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            @inject('channels', 'Mrpath\Core\Repositories\ChannelRepository')
                    ...
                    {!! view_render_event('mrpath.admin.cms.pages.create_form_accordian.general.after') !!}


                    {!! view_render_event('mrpath.admin.cms.pages.create_form_accordian.seo.before') !!}
                    ...
                    {!! view_render_event('mrpath.admin.cms.pages.create_form_accordian.seo.after') !!}
                </div>
            </div>
        </form>
    </div>
