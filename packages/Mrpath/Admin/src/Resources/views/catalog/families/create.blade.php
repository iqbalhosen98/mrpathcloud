        ...
        <form method="POST" action="{{ route('admin.catalog.families.store') }}" @submit.prevent="onSubmit">
            ...
            <div class="page-content">
                ...
                <div class="form-container">
                    ...
                    {!! view_render_event('mrpath.admin.catalog.family.create_form_accordian.general.before') !!}

                    <accordian :title="'{{ __('admin::app.catalog.families.general') }}'" :active="true">
                        <div slot="body">

                            {!! view_render_event('mrpath.admin.catalog.family.create_form_accordian.general.controls.before') !!}
                            ...
                            {!! view_render_event('mrpath.admin.catalog.family.create_form_accordian.general.controls.after') !!}

                        </div>
                    </accordian>

                    {!! view_render_event('mrpath.admin.catalog.family.create_form_accordian.general.after') !!}


                    {!! view_render_event('mrpath.admin.catalog.family.create_form_accordian.groups.before') !!}
                    ...
                    <accordian :title="'{{ __('admin::app.catalog.families.groups') }}'" :active="true">
                        <div slot="body">
                            ...
                            {!! view_render_event('mrpath.admin.catalog.family.create_form_accordian.groups.controls.before') !!}

                            <group-list></group-list>

                            {!! view_render_event('mrpath.admin.catalog.family.create_form_accordian.groups.controls.after') !!}
                        </div>
                    </accordian>

                    {!! view_render_event('mrpath.admin.catalog.family.create_form_accordian.groups.after') !!}
