{!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.videos.before', ['product' => $product]) !!}

<accordian :title="'{{ __('admin::app.catalog.products.videos') }}'" :active="false">
    <div slot="body">
        {!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.videos.controls.before', ['product' => $product]) !!}
        ...
        {!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.videos.controls.after', ['product' => $product]) !!}
    </div>
</accordian>

{!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.videos.after', ['product' => $product]) !!}
