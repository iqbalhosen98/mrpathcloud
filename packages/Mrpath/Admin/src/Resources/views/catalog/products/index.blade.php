...
@section('content')
    <div class="content" style="height: 100%;">
        ...
        {!! view_render_event('mrpath.admin.catalog.products.list.before') !!}

        <div class="page-content">
            <datagrid-plus src="{{ route('admin.catalog.products.index') }}"></datagrid-plus>
        </div>

        {!! view_render_event('mrpath.admin.catalog.products.list.after') !!}
    </div>
...
@push('scripts')
    @include('admin::export.export', ['gridName' => app('Mrpath\Admin\DataGrids\ProductDataGrid')])
