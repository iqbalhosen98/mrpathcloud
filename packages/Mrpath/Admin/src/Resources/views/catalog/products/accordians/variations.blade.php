...
{!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.variations.before', ['product' => $product]) !!}

<accordian :title="'{{ __('admin::app.catalog.products.variations') }}'" :active="true">
    <div slot="body">
        {!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.variations.controls.before', ['product' => $product]) !!}
        ...
        {!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.variations.controls.after', ['product' => $product]) !!}
    </div>
</accordian>

{!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.variations.after', ['product' => $product]) !!}
...
@push('scripts')
    ...
    <script>
        ...
        let super_attributes = @json(app('\Mrpath\Product\Repositories\ProductRepository')->getSuperAttributes($product));
