...
{!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.customer_group_prices.before', ['product' => $product]) !!}

<customer-group-price-list></customer-group-price-list>

{!! view_render_event('mrpath.admin.catalog.product.edit_form_accordian.customer_group_prices.after', ['product' => $product]) !!}
