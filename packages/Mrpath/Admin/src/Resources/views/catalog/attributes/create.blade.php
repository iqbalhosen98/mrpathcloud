        ...
        <form method="POST" action="{{ route('admin.catalog.attributes.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.general.before') !!}

                    <accordian :title="'{{ __('admin::app.catalog.attributes.general') }}'" :active="true">
                        <div slot="body">

                            {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.general.controls.before') !!}
                            ...
                            {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.general.controls.after') !!}

                        </div>
                    </accordian>

                    {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.general.after') !!}


                    {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.label.before') !!}

                    <accordian :title="'{{ __('admin::app.catalog.attributes.label') }}'" :active="true">
                        <div slot="body">

                            {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.label.controls.before') !!}
                            ...
                            @foreach (app('Mrpath\Core\Repositories\LocaleRepository')->all() as $locale)
                            ...
                            {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.label.controls.after') !!}

                        </div>
                    </accordian>

                    {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.label.after') !!}



                    <div class="hide">
                        {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.options.before') !!}

                        <accordian :title="'{{ __('admin::app.catalog.attributes.options') }}'" :active="true" :id="'options'">
                            <div slot="body">

                                {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.options.controls.before') !!}

                                <option-wrapper></option-wrapper>

                                {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.options.controls.after') !!}

                            </div>
                        </accordian>

                        {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.options.after') !!}
                    </div>


                    {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.validations.before') !!}
                    ...
                    {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.validations.after') !!}


                    {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.configuration.before') !!}

                    <accordian :title="'{{ __('admin::app.catalog.attributes.configuration') }}'" :active="true">
                        <div slot="body">

                            {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.configuration.controls.before') !!}
                            ...
                            {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.configuration.controls.after') !!}

                        </div>
                    </accordian>

                    {!! view_render_event('mrpath.admin.catalog.attribute.create_form_accordian.configuration.after') !!}
