<form
    ...
    <div class="page-content">
        <div class="form-container">
            ...
            <div slot="body">
                {!! view_render_event('mrpath.admin.customer.edit.form.before', ['customer' => $customer]) !!}
                ...
                {!! view_render_event('mrpath.admin.customer.edit.first_name.after', ['customer' => $customer]) !!}
                ...
                {!! view_render_event('mrpath.admin.customer.edit.last_name.after', ['customer' => $customer]) !!}
                ...
                {!! view_render_event('mrpath.admin.customer.edit.email.after', ['customer' => $customer]) !!}
                ...
                {!! view_render_event('mrpath.admin.customer.edit.gender.after', ['customer' => $customer]) !!}
                ...
                {!! view_render_event('mrpath.admin.customer.edit.status.after', ['customer' => $customer]) !!}
                ...
                {!! view_render_event('mrpath.admin.customer.edit.is_suspended.after', ['customer' => $customer]) !!}
                ...
                {!! view_render_event('mrpath.admin.customer.edit.date_of_birth.after', ['customer' => $customer]) !!}
                ...
                {!! view_render_event('mrpath.admin.customer.edit.phone.after', ['customer' => $customer]) !!}
                ...
                {!! view_render_event('mrpath.admin.customer.edit.form.after', ['customer' => $customer]) !!}
            </div>
