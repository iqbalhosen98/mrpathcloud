        ...
        <form method="POST" action="{{ route('admin.customer.store') }}" @submit.prevent="onSubmit">
            ...
            <div class="page-content">
                ...
                <div class="form-container">
                    ...
                    {!! view_render_event('mrpath.admin.customers.create.before') !!}
                    ...
                    {!! view_render_event('mrpath.admin.customers.create.first_name.after') !!}
                    ...
                    {!! view_render_event('mrpath.admin.customers.create.last_name.after') !!}
                    ...
                    {!! view_render_event('mrpath.admin.customers.create.email.after') !!}
                    ...
                    {!! view_render_event('mrpath.admin.customers.create.gender.after') !!}
                    ...
                    {!! view_render_event('mrpath.admin.customers.create.date_of_birth.after') !!}
                    ...
                    {!! view_render_event('mrpath.admin.customers.create.phone.after') !!}
                    ...
                    {!! view_render_event('mrpath.admin.customers.create.after') !!}
                </div>
            </div>
        </form>
    </div>
