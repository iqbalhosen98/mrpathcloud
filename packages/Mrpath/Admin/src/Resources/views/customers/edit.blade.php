...
@section('content')
    <div class="content">
        ...
        <tabs>
            {!! view_render_event('mrpath.admin.customer.edit.before', ['customer' => $customer]) !!}
                ...
                <tab name="{{ __('admin::app.layouts.invoices') }}" :selected="false">
                    ...
                    {!! view_render_event('mrpath.admin.customer.invoices.list.before') !!}

                        <datagrid-plus src="{{ route('admin.customer.invoices.data', $customer->id) }}"></datagrid-plus>

                    {!! view_render_event('mrpath.admin.customer.invoices.list.after') !!}
                    </div>
                </tab>
                ...
                <tab name="{{ __('admin::app.customers.orders.title') }}" :selected="false">
                    ...
                    {!! view_render_event('mrpath.admin.customer.orders.list.before') !!}

                        <datagrid-plus src="{{ route('admin.customer.orders.data', $customer->id) }}"></datagrid-plus>

                    {!! view_render_event('mrpath.admin.customer.orders.list.after') !!}
                    </div>
                </tab>

            {!! view_render_event('mrpath.admin.customer.edit.after', ['customer' => $customer]) !!}
        </tabs>
    </div>
@stop