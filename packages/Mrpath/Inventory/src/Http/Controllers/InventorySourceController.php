...
namespace Mrpath\Inventory\Http\Controllers;

use Mrpath\Admin\DataGrids\InventorySourcesDataGrid;
use Mrpath\Inventory\Http\Requests\InventorySourceRequest;
