...
use Mrpath\Checkout\Database\Factories\CartAddressFactory;
use Mrpath\Checkout\Contracts\CartAddress as CartAddressContract;
use Mrpath\Core\Models\Address;

/**
 * Class CartAddress
 *
 * @package Mrpath\Checkout\Models
 *
