...
namespace Mrpath\Checkout;

use Exception;
use Illuminate\Support\Arr;
use Illuminate\Support\Facades\Event;
use Mrpath\Checkout\Models\CartAddress;
use Mrpath\Checkout\Models\Cart as CartModel;
use Mrpath\Checkout\Models\CartPayment;
use Mrpath\Checkout\Repositories\CartAddressRepository;
use Mrpath\Checkout\Repositories\CartItemRepository;
use Mrpath\Checkout\Repositories\CartRepository;
use Mrpath\Checkout\Traits\CartCoupons;
use Mrpath\Checkout\Traits\CartTools;
use Mrpath\Checkout\Traits\CartValidators;
...
use Mrpath\Shipping\Facades\Shipping;
use Mrpath\Tax\Helpers\Tax;
use Mrpath\Tax\Repositories\TaxCategoryRepository;
...
class Cart
{
     ...
     *
     * @var \Mrpath\Checkout\Repositories\CartRepository
     */
     ...
     *
     * @var \Mrpath\Checkout\Repositories\CartItemRepository
     */
     ...
     *
     * @var \Mrpath\Checkout\Repositories\CartAddressRepository
     */
     ...
     *
     * @var \Mrpath\Tax\Repositories\TaxCategoryRepository
     */
     ...
     *
     * @param  \Mrpath\Checkout\Repositories\CartRepository             $cartRepository
     * @param  \Mrpath\Checkout\Repositories\CartItemRepository         $cartItemRepository
     * @param  \Mrpath\Checkout\Repositories\CartAddressRepository      $cartAddressRepository
     * @param  \Mrpath\Product\Repositories\ProductRepository           $productRepository
     * @param  \Mrpath\Tax\Repositories\TaxCategoryRepository           $taxCategoryRepository
     ...
     * Returns cart.
     *
     * @return \Mrpath\Checkout\Contracts\Cart|null
     */
    public function getCart(): ?\Mrpath\Checkout\Contracts\Cart
    {
        $cart = null;
     ...
     *
     * @param  array  $data
     * @return \Mrpath\Checkout\Contracts\CartItem|void
     */
     ...
     * @param  int  $productId
     * @param  array  $data
     * @return \Mrpath\Checkout\Contracts\Cart|string|array
     * @throws Exception
     */
     ...
     *
     * @param \Mrpath\Checkout\Models\Cart|null $cart
     * @return \Mrpath\Checkout\Models\Cart|null
     */
     ...
     * @return \Mrpath\Checkout\Contracts\CartPayment
     */
     ...
     *
     * @param  \Mrpath\Checkout\Contracts\CartItem  $item
     * @return \Mrpath\Checkout\Contracts\CartItem
     */
    protected function setItemTaxToZero(\Mrpath\Checkout\Contracts\CartItem $item): \Mrpath\Checkout\Contracts\CartItem
    {
        $item->tax_percent = 0;
        $item->tax_amount = 0;
     ...
     */
    private function assignCustomerFields(\Mrpath\Checkout\Contracts\Cart $cart): void
    {
        if (
            auth()->guard()->check()
     ...
     * Round cart totals.
     *
     * @param \Mrpath\Checkout\Models\Cart $cart
     * @return \Mrpath\Checkout\Models\Cart
     */
     ...
     * @return bool
     */
    private function isCartItemInactive(\Mrpath\Checkout\Contracts\CartItem $item): bool
    {
     ...
     * @return array
     */
    private function gatherBillingAddress($data, \Mrpath\Checkout\Models\Cart $cart): array
    {
        $customerAddress = [];
     ...
     *
     * @param  array  $data
     * @param  \Mrpath\Checkout\Cart|null  $cart
     * @return array
     */
    private function gatherShippingAddress($data, \Mrpath\Checkout\Models\Cart $cart): array
    {
        $customerAddress = [];
    ...
    private function linkAddresses(
        \Mrpath\Checkout\Models\Cart $cart,
