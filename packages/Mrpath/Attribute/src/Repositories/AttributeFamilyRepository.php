...
use Mrpath\Attribute\Repositories\AttributeGroupRepository;
...
class AttributeFamilyRepository extends Repository
{
     ...
     *
     * @var \Mrpath\Attribute\Repositories\AttributeGroupRepository
     */
     ...
     * @param  \Mrpath\Attribute\Repositories\AttributeGroupRepository  $attributeGroupRepository
     * @return void
     */
    ...
    function model()
    {
        return 'Mrpath\Attribute\Contracts\AttributeFamily';
    }
