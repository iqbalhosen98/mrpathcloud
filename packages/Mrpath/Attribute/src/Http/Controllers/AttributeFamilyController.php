...
namespace Mrpath\Attribute\Http\Controllers;

use Mrpath\Admin\DataGrids\AttributeFamilyDataGrid;
...
class AttributeFamilyController extends Controller
{
    ...
    public function store()
    {
        $this->validate(request(), [
            'code' => ['required', 'unique:attribute_families,code', new \Mrpath\Core\Contracts\Validations\Code],
            'name' => 'required',
        ]);
    ...
    {
        $this->validate(request(), [
            'code' => ['required', 'unique:attribute_families,code,' . $id, new \Mrpath\Core\Contracts\Validations\Code],
            'name' => 'required',
        ]);
