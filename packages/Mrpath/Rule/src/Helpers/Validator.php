...
class Validator
{
     ...
     *
     * @param  \Mrpath\CartRule\Contracts\CartRule|\Mrpath\CatalogRule\Contracts\CatalogRule  $rule
     * @param  \Mrpath\Checkout\Contracts\Cart|\Mrpath\Checkout\Contracts\CartItem|\Mrpath\Product\Contracts\Product  $entity
     * @return boolean
     */
    public function validate($rule, $entity)
    {
        ...
        foreach ($rule->conditions as $condition) {
            ...
            if ($entity instanceof \Mrpath\Checkout\Contracts\Cart && strpos($condition['attribute'], 'cart|') === false) {
                continue;
            }
     ...
     * @param  \Mrpath\Checkout\Contracts\CartItem|\Mrpath\Product\Contracts\Product  $entity
     * @return boolean
     */
    public function getAttributeValue($condition, $entity)
    {
        ...
        switch (current($chunks)) {
            case 'cart':
                $cart = $entity instanceof \Mrpath\Checkout\Contracts\Cart ? $entity : $entity->cart;
            ...
            case 'product':
                if ($attributeCode == 'category_ids') {
                    ...
                    if (! in_array($condition['attribute_type'], ['multiselect', '0'])) {
                        return $value;
                    }
     ...
     *
     * @param  array  $condition
     * @param  \Mrpath\Checkout\Contracts\CartItem  $entity
     * @return bool
     */
     ...
     * @param  \Mrpath\Checkout\Contracts\Cart|\Mrpath\Checkout\Contracts\CartItem|\Mrpath\Product\Contracts\Product  $item
     * @return array
     */
