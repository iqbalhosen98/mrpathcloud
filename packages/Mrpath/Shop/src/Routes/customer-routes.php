...
use Mrpath\Customer\Http\Controllers\AccountController;
use Mrpath\Customer\Http\Controllers\AddressController;
use Mrpath\Customer\Http\Controllers\CustomerController;
use Mrpath\Customer\Http\Controllers\ForgotPasswordController;
use Mrpath\Customer\Http\Controllers\RegistrationController;
use Mrpath\Customer\Http\Controllers\ResetPasswordController;
use Mrpath\Customer\Http\Controllers\SessionController;
use Mrpath\Customer\Http\Controllers\WishlistController;
use Mrpath\Shop\Http\Controllers\DownloadableProductController;
use Mrpath\Shop\Http\Controllers\OrderController;
use Mrpath\Shop\Http\Controllers\ReviewController;
