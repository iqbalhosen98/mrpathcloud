...
use Mrpath\CMS\Http\Controllers\Shop\PagePresenterController;
use Mrpath\Shop\Http\Controllers\HomeController;
use Mrpath\Shop\Http\Controllers\ProductController;
use Mrpath\Shop\Http\Controllers\ReviewController;
use Mrpath\Shop\Http\Controllers\SearchController;
use Mrpath\Shop\Http\Controllers\SubscriptionController;
...
Route::group(['middleware' => ['web', 'locale', 'theme', 'currency']], function () {
    ...
    Route::group(['middleware' => ['cart.merger']], function () {
         ...
         * Fallback route.
         */
        Route::fallback(\Mrpath\Shop\Http\Controllers\ProductsCategoriesProxyController::class . '@index')
            ->defaults('_config', [
