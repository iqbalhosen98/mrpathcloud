    ...
    <div class="header-top">
        ...
        <div class="right-content">
            ...
            <ul class="right-content-menu">
                ...
                {!! view_render_event('mrpath.shop.layout.header.comppare-item.before') !!}
               ...
               @php
                ...
                {!! view_render_event('mrpath.shop.layout.header.compare-item.after') !!}

                {!! view_render_event('mrpath.shop.layout.header.currency-item.before') !!}
                ...
                {!! view_render_event('mrpath.shop.layout.header.currency-item.after') !!}


                {!! view_render_event('mrpath.shop.layout.header.account-item.before') !!}
                ...
                {!! view_render_event('mrpath.shop.layout.header.account-item.after') !!}


                {!! view_render_event('mrpath.shop.layout.header.cart-item.before') !!}
                ...
                {!! view_render_event('mrpath.shop.layout.header.cart-item.after') !!}
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            @auth('customer')
                @php
                    $compareCount = app('Mrpath\Velocity\Repositories\VelocityCustomerCompareProductRepository')
                        ->count([
