...
@section('content-wrapper')
    <div class="auth-content">
        ...
        {!! view_render_event('mrpath.shop.customers.login.before') !!}
        ...
        <form method="POST" action="{{ route('customer.session.create') }}" @submit.prevent="onSubmit">
            ...
            <div class="login-form">
                ...
                {!! view_render_event('mrpath.shop.customers.login_form_controls.before') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.login_form_controls.after') !!}
        ...
        {!! view_render_event('mrpath.shop.customers.login.after') !!}
    </div>
@stop
