...
@section('account-content')
    <div class="account-layout">
        ...
        {!! view_render_event('mrpath.shop.customers.account.reviews.list.before', ['reviews' => $reviews]) !!}
        ...
        {!! view_render_event('mrpath.shop.customers.account.reviews.list.after', ['reviews' => $reviews]) !!}
    </div>
@endsection
