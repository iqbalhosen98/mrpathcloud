...
@section('account-content')
    <div class="account-layout">
        ...
        {!! view_render_event('mrpath.shop.customers.account.address.list.before', ['addresses' => $addresses]) !!}
        ...
        {!! view_render_event('mrpath.shop.customers.account.address.list.after', ['addresses' => $addresses]) !!}
    </div>
@endsection
