    ...
    <div class="account-layout">
        ...
        <form method="post" action="{{ route('customer.profile.store') }}" @submit.prevent="onSubmit">
            <div class="edit-form">
                ...
                {!! view_render_event('mrpath.shop.customers.account.profile.edit.first_name.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.profile.edit.last_name.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.profile.edit.gender.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.profile.edit.date_of_birth.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.profile.edit.email.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.profile.edit.phone.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.profile.edit.oldpassword.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.profile.edit.password.after') !!}
