...
@section('account-content')
    <div class="account-layout">
        ...
        {!! view_render_event('mrpath.shop.customers.account.address.create.before') !!}

        <form id="customer-address-form" method="post" action="{{ route('customer.address.store') }}" @submit.prevent="onSubmit">
            <div class="account-table-content">
                @csrf

                {!! view_render_event('mrpath.shop.customers.account.address.create_form_controls.before') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.create_form_controls.company_name.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.create_form_controls.first_name.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.create_form_controls.last_name.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.create_form_controls.vat_id.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.create_form_controls.street-address.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.create_form_controls.city.after') !!}

                @include ('shop::customers.account.address.country-state', ['countryCode' => old('country'), 'stateCode' => old('state')])

                {!! view_render_event('mrpath.shop.customers.account.address.create_form_controls.country-state.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.create_form_controls.postcode.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.create_form_controls.after') !!}
        ...
        {!! view_render_event('mrpath.shop.customers.account.address.create.after') !!}
    </div>
@endsection
