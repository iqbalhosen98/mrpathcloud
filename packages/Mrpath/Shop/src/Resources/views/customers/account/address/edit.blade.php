...
@section('account-content')
    <div class="account-layout">
        ...
        {!! view_render_event('mrpath.shop.customers.account.address.edit.before', ['address' => $address]) !!}
        ...
        <form id="customer-address-form" method="post" action="{{ route('customer.address.update', $address->id) }}" @submit.prevent="onSubmit">
            ...
            <div class="account-table-content">
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.edit_form_controls.before', ['address' => $address]) !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.edit_form_controls.company_name.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.edit_form_controls.first_name.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.edit_form_controls.last_name.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.edit_form_controls.vat_id.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.edit_form_controls.street-addres.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.edit_form_controls.create.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.edit_form_controls.country-state.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.edit_form_controls.postcode.after') !!}
                ...
                {!! view_render_event('mrpath.shop.customers.account.address.edit_form_controls.after', ['address' => $address]) !!}
        ...
        {!! view_render_event('mrpath.shop.customers.account.address.edit.after', ['address' => $address]) !!}
    </div>
@endsection
