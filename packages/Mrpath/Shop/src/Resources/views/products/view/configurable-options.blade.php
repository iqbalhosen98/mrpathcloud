@if (Mrpath\Product\Helpers\ProductType::hasVariants($product->type))

    @inject ('configurableOptionHelper', 'Mrpath\Product\Helpers\ConfigurableOption')

    {!! view_render_event('mrpath.shop.products.view.configurable-options.before', ['product' => $product]) !!}

    <product-options></product-options>

    {!! view_render_event('mrpath.shop.products.view.configurable-options.after', ['product' => $product]) !!}
