@inject ('wishListHelper', 'Mrpath\Customer\Helpers\Wishlist')
...
{!! view_render_event('mrpath.shop.products.view.gallery.before', ['product' => $product]) !!}
...
{!! view_render_event('mrpath.shop.products.view.gallery.after', ['product' => $product]) !!}
