...
@section('content-wrapper')
    ...
    <div class="main">
        {!! view_render_event('mrpath.shop.products.index.before', ['category' => $category]) !!}
            ...
            <div class="category-block" @if ($category->display_mode == 'description_only') style="width: 100%" @endif>
                ...
                @if (in_array($category->display_mode, [null, 'products_only', 'products_and_description']))
                    ...
                    @if ($products->count())
                        ...
                        {!! view_render_event('mrpath.shop.products.index.pagination.before', ['category' => $category]) !!}

                        <div class="bottom-toolbar">
                            {{ $products->appends(request()->input())->links() }}
                        </div>

                        {!! view_render_event('mrpath.shop.products.index.pagination.after', ['category' => $category]) !!}
        ...
        {!! view_render_event('mrpath.shop.products.index.after', ['category' => $category]) !!}
    </div>
@stop
