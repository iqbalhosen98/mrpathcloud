            ...
            <div class="cart-content">
                <div class="left-side">
                    <form action="{{ route('shop.checkout.cart.update') }}" method="POST" @submit.prevent="onSubmit">
                            ...
                            @foreach ($cart->items as $key => $item)
                                ...
                                <div class="item mt-5">
                                    ...
                                    <div class="item-details">
                                        ...
                                        {!! view_render_event('mrpath.shop.checkout.cart.item.name.before', ['item' => $item]) !!}
                                        ...
                                        {!! view_render_event('mrpath.shop.checkout.cart.item.name.after', ['item' => $item]) !!}


                                        {!! view_render_event('mrpath.shop.checkout.cart.item.price.before', ['item' => $item]) !!}

                                        <div class="price">
                                            {{ core()->currency($item->base_price) }}
                                        </div>

                                        {!! view_render_event('mrpath.shop.checkout.cart.item.price.after', ['item' => $item]) !!}


                                        {!! view_render_event('mrpath.shop.checkout.cart.item.options.before', ['item' => $item]) !!}
                                        ...
                                        {!! view_render_event('mrpath.shop.checkout.cart.item.options.after', ['item' => $item]) !!}


                                        {!! view_render_event('mrpath.shop.checkout.cart.item.quantity.before', ['item' => $item]) !!}
                                        ...
                                        {!! view_render_event('mrpath.shop.checkout.cart.item.quantity.after', ['item' => $item]) !!}
                        ...
                        {!! view_render_event('mrpath.shop.checkout.cart.controls.after', ['cart' => $cart]) !!}
                ...
                <div class="right-side">
                    {!! view_render_event('mrpath.shop.checkout.cart.summary.after', ['cart' => $cart]) !!}
