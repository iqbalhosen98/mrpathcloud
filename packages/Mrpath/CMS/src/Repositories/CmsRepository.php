...
namespace Mrpath\CMS\Repositories;

use Illuminate\Support\Facades\Event;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use Mrpath\Core\Eloquent\Repository;
use Mrpath\CMS\Models\CmsPageTranslationProxy;
...
class CmsRepository extends Repository
{
    ...
    function model()
    {
        return 'Mrpath\CMS\Contracts\CmsPage';
    }
     ...
     *
     * @param  string  $urlKey
     * @return \Mrpath\CMS\Contracts\CmsPage|\Exception
     */
