...
namespace Mrpath\Shipping\Carriers;

use Mrpath\Checkout\Facades\Cart;
use Mrpath\Checkout\Models\CartShippingRate;
...
class FlatRate extends AbstractShipping
{
     ...
     *
     * @return \Mrpath\Checkout\Models\CartShippingRate|false
     */
     ...
     * Get rate.
     *
     * @return \Mrpath\Checkout\Models\CartShippingRate
     */
    public function getRate(): \Mrpath\Checkout\Models\CartShippingRate
    {
        $cart = Cart::getCart();
