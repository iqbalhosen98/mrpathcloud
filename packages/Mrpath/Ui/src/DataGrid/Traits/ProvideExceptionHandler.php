...
namespace Mrpath\Ui\DataGrid\Traits;
...
trait ProvideExceptionHandler
{
     ...
     *
     * @param  array  $column
     * @return void|\Mrpath\Ui\Exceptions\ColumnKeyException
     */
    public function checkRequiredColumnKeys($column)
    {
        $this->checkRequiredKeys($this->requiredColumnKeys, $column, function ($missingKeys) {
            ...
            throw new \Mrpath\Ui\Exceptions\ColumnKeyException($message);
        });
    }
     ...
     *
     * @param  array  $action
     * @return void|\Mrpath\Ui\Exceptions\ActionKeyException
     */
    public function checkRequiredActionKeys($action)
    {
        $this->checkRequiredKeys($this->requiredActionKeys, $action, function ($missingKeys) {
            ...
            throw new \Mrpath\Ui\Exceptions\ActionKeyException($message);
        });
    }
