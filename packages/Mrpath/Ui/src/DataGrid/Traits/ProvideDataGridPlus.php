...
trait ProvideDataGridPlus
{
    ...
    public function getCurrentExtraFilterValue()
    {
        ...
        if ($channel !== 'all') {
            $channelLocales = app('Mrpath\Core\Repositories\ChannelRepository')->findOneByField('code', $channel)->locales;
     ...
     *
     * To Do (@devansh-mrpath): Use translation from JS method by encoding lang file.
     *
     * @return array
     */
