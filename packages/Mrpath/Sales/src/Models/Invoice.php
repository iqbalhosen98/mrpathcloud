...
use Mrpath\Sales\Contracts\Invoice as InvoiceContract;
use Mrpath\Sales\Traits\PaymentTerm;
use Mrpath\Sales\Database\Factories\InvoiceFactory;
use Illuminate\Database\Eloquent\Relations\BelongsTo;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Mrpath\Sales\Traits\InvoiceReminder;
