...
namespace Mrpath\CartRule\Helpers;
...
class CartRule
{
     ...
     * Validator object
     *
     * @var \Mrpath\Rule\Helpers\Validator
     */
    protected $validator;
     ...
     *
     * @param                                     $cart
     * @param \Mrpath\CartRule\Contracts\CartRule $rule
     *
     * @return bool
     */
    public function canProcessRule($cart, $rule): bool
    {
        if ($rule->coupon_type) {
            if (strlen($cart->coupon_code)) {
                /** @var \Mrpath\CartRule\Models\CartRule $rule */
     ...
     * @return \Mrpath\Rule\Helpers\Validator
     */
