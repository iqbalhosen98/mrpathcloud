...
class CartCest extends CustomerCest
{
    ...
    public function testForRemovingItemFromTheCart(ApiTester $I)
    {
        ...
        $I->assertEquals(2, \Mrpath\Checkout\Facades\Cart::getCart()->items()->count());
        ...
        $I->assertEquals(1, \Mrpath\Checkout\Facades\Cart::getCart()->items()->count());
    }
    ...
    public function testForEmptyCart(ApiTester $I)
    {
        ...
        $I->assertNull(\Mrpath\Checkout\Facades\Cart::getCart());
    }
