...
use Mrpath\CartRule\Models\CartRule;
use Mrpath\CartRule\Models\CartRuleCoupon;
use Helper\Bagisto;
use Mrpath\Customer\Models\Customer;
use Mrpath\Customer\Models\CustomerAddress;
use Illuminate\Contracts\Support\Arrayable;
use Mrpath\Product\Repositories\ProductDownloadableLinkRepository;
use Mrpath\Sales\Repositories\DownloadableLinkPurchasedRepository;
...
class CartRuleCest
{
    ...
    public function checkCartWithCoupon(UnitTester $I, Example $scenario): void
    {
        ...
        $I->seeRecord(\Mrpath\Checkout\Models\Cart::class, $expectedCart->toArray());
